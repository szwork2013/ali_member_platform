...
Weixin.prototype.init = function(req){
	this.appID = req.app.config.weixin.AppId;
	this.appsecret = req.app.config.weixin.AppSecret;
	return this;
};
//发送请求
//发送request
...
Weixin.prototype.mergeOpenid = function(req, user, callback){
	...
	//关联到的账户的openid
	if(!user.weixin || !user.weixin.openid){
		user.weixin = {};
