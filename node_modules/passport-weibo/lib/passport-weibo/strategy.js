...
function Strategy(options, verify) {
  ...
  options.tokenURL = options.tokenURL || 'https://api.weibo.com/oauth2/access_token&grant_type=authorization_code';
  ...
  this.name = 'weibo';
  this._userProfileURL = options.userProfileURL || 'https://api.weibo.com/2/account/get_uid.json';
}
