...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'https://api.weibo.com/oauth2/authorize';  //'http://api.t.sina.com.cn/oauth/authorize';
  options.tokenURL = options.tokenURL || 'https://api.weibo.com/oauth2/access_token?grant_type=authorization_code&code=CODE';  //'http://api.t.sina.com.cn/oauth/authorize?oauth_token';
