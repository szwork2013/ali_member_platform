...
////			  req.app.logger.log(req.app, req.user.username, req.app.reqip.getClientIp(req), 'reducePoints', 'convertCode', '用户' + req.user.username + '兑换消费积分.(原总积分:' + result.oldPoints + ',消费积分:' + result.reducePoints + ',新总积分:' + req.user.roles.account.integral.points + ')');
////
